"""
Code Description: Launch File to run all necessary ground station scripts and puts it all in a custom UI. 
                  Basic UI such as Flask Camera Feed and Serial Monitor/Output (No GPS Mapping)
"""
