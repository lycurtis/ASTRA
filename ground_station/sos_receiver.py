"""
Code Description: Receives Messages using UDP and processes the input to output + playing an alert sound if person detected and outputting GPS coordinates of drone
"""
import socket
import time
import winsound
